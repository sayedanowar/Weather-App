...
def getweather(*args):
    ...
    try:
        ...
        weather_in_lable = Label(window, text=weather_in,font=('Arial',26,'bold'), background='#0085FF', foreground='White')
...
sb_image = Label(image=search_bar_image, background='#0085FF')
...
weather_in_text = Label(window, font=('Arial', 16, 'bold'), background='#0085FF', foreground='#FFFF00')
...
logo = Label(image=app_logo, background='#0085FF')
...
current_time_text = Label(window, font=('Arial', 14, 'bold'), background='#0085FF', foreground='#FFFF00')
current_time_text.config(text='CURRENT TIME')
current_time_text.place(x=593, y=80)

time = Label(window, font=('Arial', 12, 'bold'), background='#0085FF', foreground='White')
time.place(x=625, y=110)

time_zone_text = Label(window, font=('Arial', 14, 'bold'), background='#0085FF', foreground='#FFFF00')
time_zone_text.config(text='TIMEZONE')
time_zone_text.place(x=615, y=10)

show_time_zone = Label(window, font=('Arial', 12, 'bold'), background='#0085FF', foreground='White')
show_time_zone.place(x=615, y=45)

# Temprature Settings

temprature = Label(font=('Arial', 50, 'bold'), background='#0085FF', foreground="#FF9A00")
temprature.place(x=200, y=180)

feeles_like_temp = Label(font=('Arial', 12, 'bold'), background='#0085FF', foreground='White')
